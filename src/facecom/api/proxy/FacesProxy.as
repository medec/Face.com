	...
	public class FacesProxy extends Proxy {
		...
		public function detect(photoURLs : Array = null, photo : BitmapData = null, detector : String = 'Aggressive', attributes : String = 'all', callback_url : String = null) : void {
			...
			if (photoURLs) {
				...
				clientAPI.getJPEG(photo, _recognize, ml);
			}
		}

		private function _detect(ml : MultipartURLLoader) : void {
		...
		private function _recognize(loader : MultipartURLLoader) : void {
			loader.load(FaceAPI.API_DOMAIN + 'faces/recognize.json');
		}
		...
		private function _group(ml : MultipartURLLoader) : void {
